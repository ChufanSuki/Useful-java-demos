...
public class Layouts {
  public static void main(String[] args) {
      // GUI Look And Feel
      // Use the GUI LookAndFeel of the native platform.
      // Ok to ignore exception.
      try {
          UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
      } catch (Exception ignored) { }

      // 1. FLow layout -- Left-right top-bottom, like text
      ...
      // Before the layout manager lays everything out call frame.setMinimumSize()
      // frame.setMaximumSize(), frame.setPreferredSize() once or more.
      ...
      frame3.add(new JLabel("Center"), BorderLayout.CENTER);
